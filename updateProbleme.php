...
if (
    isset($_POST["idprobleme"]) &&
    isset($_POST["description"]) &&
    isset($_POST["dateCreation"])
) {
    if (
        !empty($_POST["idprobleme"]) &&
        ...
        $problemeC->updateprobleme($probleme, $_POST["idprobleme"]);
...
<body>
    ...
    <?php
    if (isset($_POST['idprobleme'])) {
        $probleme = $problemeC->showprobleme($_POST['idprobleme']);

    ?>
   
   <div class="container-fluid pt-4 px-4" >
                <div class="row g-4">
                <a href="ListProbleme.php">back to List</a>
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Update Probleme </h6>
                            
    <form action="" method="POST">
                    <div class="mb-3">
                    <label class="form-label" for="idprobleme">Id Probleme:</label>
                    <input class="form-control" type="text" name="idprobleme" id="idprobleme" value="<?php echo $probleme['idprobleme']; ?>">
                    </div>

                    <div class="mb-3">
                    <label class="form-label" for="description">Description:</label>
                    <input class="form-control" type="text" name="description" id="description" value="<?php echo $probleme['description']; ?>">
                    </div>
         
                    <div class="mb-3">
                    <label class="form-label"for="dateCreation">Date de Creation:</label>
                    <input class="form-control"type="date" name="dateCreation" id="dateCreation" value="<?php echo $probleme['dateCreation']; ?>">
                    </div>
