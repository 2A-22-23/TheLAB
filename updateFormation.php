...
if (
    ...
    if (
        ...
        $formationC->updateformation($formation, $_POST["idformation"]);
...
<body>
    ...
    if (isset($_POST['idformation'])) {
        $formation = $formationC->showformation($_POST['idformation']);
                ...
                <a href="Listformation.php">back to List</a>
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">update formation </h6>
                            
                <form action="" method="POST">
                    <div class="mb-3">
                    <label class="form-label" for="idformation">IdFormation:</label>
                    <input class="form-control" type="text" name="idformation" id="idformation" value="<?php echo $formation['idformation']; ?>" maxlength="20">
                    </div>
         
                    

                    <div class="mb-3">
                    <label class="form-label" for="typeformation">Type des formations cree:</label>

                     <div class="form-floating mb-3">
                    <select class="form-select" name="typeformation" id="typeformation" aria-label="Floating label select example">
                    ...
                    <input class="form-control"type="text" name="discription" id="discription" value="<?php echo $formation['discription']; ?>" maxlength="20">
                    </div>

                    <div class="mb-3">
                    <label class="form-label" for="Article">Article:</label>
                    <input class="form-control" type="text" name="Article" id="Article" value="<?php echo $formation['Article']; ?>" maxlength="20">
                    </div>

                    <div class="mb-3">
                    <label class="form-label" for="pd_img">Videos:</label>
                    <input  class="form-control form-control-sm bg-dark"  type="file" name="pd_img" id="pd-img" placeholder="Enter pd_img " value="<?php echo $formation['pd_img']; ?>">
                    </div>
