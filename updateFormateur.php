...
if (
    ...
    if (
        ...
        $formateurC->updateformateur($formateur, $_POST["idformateur"]);
...
<body>
    ...
    if (isset($_POST['idformateur'])) {
        $formateur = $formateurC->showformateur($_POST['idformateur']);

    ?>
   
   <div class="container-fluid pt-4 px-4" >
                <div class="row g-4">
                <a href="ListFormateur.php">back to List</a>
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">update Formateur </h6>
                            
    <form action="" method="POST">
                    <div class="mb-3">
                    <label class="form-label" for="idformateur">First Name:</label>
                    <input class="form-control" type="text" name="idformateur" id="idformateur" value="<?php echo $formateur['idformateur']; ?>" maxlength="20">
                    </div>

                    <div class="mb-3">
                    <label class="form-label" for="firstName">First Name:</label>
                    <input class="form-control" type="text" name="firstName" id="firstName" value="<?php echo $formateur['firstName']; ?>" maxlength="20">
                    </div>
         
                    <div class="mb-3">
                    <label class="form-label"for="lastName">Last Name:</label>
                    <input class="form-control"type="text" name="lastName" id="lastName" value="<?php echo $formateur['lastName']; ?>" maxlength="20">
                    </div>

                    <div class="mb-3">
                    <label class="form-label" for="address">Type des formations cree:</label>

                     <div class="form-floating mb-3">
                    <select class="form-select" name="address" id="address" aria-label="Floating label select example">
                    ...
                    <input class="form-control" type="date" name="dob" id="dob" value="<?php echo $formateur['dob']; ?>">
                    </div>

                    <div class="mb-3">
                    <label class="form-label" for="pd_img">pd_img:</label>
                    <input  class="form-control form-control-sm bg-dark"  type="file" name="pd_img" id="pd-img" placeholder="Enter pd_img " value="<?php echo $formateur['pd_img']; ?>">
                    </div>
