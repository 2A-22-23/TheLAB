...
<div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Formateur</h6>
                        <a href="addFormateur.php">Add Formateur</a>
                    </div>
        ...
        ?>
          <tbody>
                ...
                <td><?= $formateur['dob']; ?></td>
                <td><?= $formateur['pd_img']; ?></td>
                <td align="center">
                    <form method="POST" action="updateFormateur.php">
                        <input class="btn btn-sm btn-primary" type="submit" name="update" value="Update">
                        <input type="hidden" value=<?PHP echo $formateur['idformateur']; ?> name="idformateur">
                    </form>
                </td>
                <td  align="center">
                    <a class="btn btn-sm btn-primary" href="deleteFormateur.php?idformateur=<?php echo $formateur['idformateur']; ?>">Delete</a>
                </td>
            </tr>
            </tbody>
