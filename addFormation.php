...
<body>
    ...
    <div class="container-fluid pt-4 px-4" >
                ...
                <a href="Listformation.php">back to List</a>
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">ADD formation </h6>
                ...
                <form action="" method="POST">
                    ...
                    <input class="form-control"type="text" name="discription" id="discription"  maxlength="20">
                    </div>

                    <div class="mb-3">
                    <label class="form-label" for="Article">Article:</label>
                    <input class="form-control" type="text" name="Article" id="Article" maxlength="20">
                    </div>
