...
<div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Probleme</h6>
                        <a href="addProbleme.php">Add Probleme</a>
                    </div>
        ...
        <?php
        foreach ($list as $probleme) {
        ?>
          <tbody>
                                <tr>
                                    <td><input class="form-check-input" type="checkbox"></td>
                <td><?= $probleme['idprobleme']; ?></td>
                <td><?= $probleme['description']; ?></td>
                <td><?= $probleme['dateCreation']; ?></td>
                <td align="center">
                    <form method="POST" action="updateProbleme.php">
                        <br>
                        <input class="btn btn-sm btn-primary" type="submit" name="update" value="Update">
                        <input type="hidden" value=<?PHP echo $probleme['idprobleme']; ?> name="idprobleme">
                    </form>
                </td>
                <td  align="center">
                    <a class="btn btn-sm btn-primary" href="deleteProbleme.php?idprobleme=<?php echo $probleme['idprobleme']; ?>">Delete</a>
                </td>
            </tr>
            </tbody>
