...
if (
    isset($_POST["idassistant"]) &&
    isset($_POST["nom"]) &&
    isset($_POST["adresseEmail"]) &&
    isset($_POST["subject"])
) {
    if (
        !empty($_POST["idassistant"]) &&
        !empty($_POST['nom']) &&
        ...
        $assistantC->updateassistant($assistant, $_POST["idassistant"]);
...
<body>
    ...
    <?php
    if (isset($_POST['idassistant'])) {
        $assistant = $assistantC->showassistant($_POST['idassistant']);
                ...
                <a href="Listassistant.php">back to List</a>
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">update assistant </h6>
                            
    <form action="" method="POST">
                    <div class="mb-3">
                    <label class="form-label" for="idassistant">Id Assistant:</label>
                    <input class="form-control" type="text" name="idassistant" id="idassistant" value="<?php echo $assistant['idassistant']; ?>">
                    </div>

                    <div class="mb-3">
                    <label class="form-label" for="nom">First Name:</label>
                    <input class="form-control" type="text" name="nom" id="nom" value="<?php echo $assistant['nom']; ?>">
                    </div>
         
                    <div class="mb-3">
                    <label class="form-label"for="adresseEmail">Adresse Email:</label>
                    <input class="form-control"type="text" name="adresseEmail" id="adresseEmail" value="<?php echo $assistant['adresseEmail']; ?>">
                    </div>

                    <div class="mb-3">
                    <label class="form-label" for="subject">Subject:</label>
                    <input class="form-control"type="text" name="subject" id="subject" value="<?php echo $assistant['subject']; ?>">
                    </div>
