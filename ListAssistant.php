...
<div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="addAssistant.php">Add Assistant</a>
                    </div>
        ...
        ?>
          <tbody>
                ...
                <td><?= $assistant['idassistant']; ?></td>
                <td><?= $assistant['nom']; ?></td>
                <td><?= $assistant['adresseEmail']; ?></td>
                ...
                <td align="center">
                    <form method="POST" action="updateAssistant.php">
                        ...
                        <input type="hidden" value=<?PHP echo $assistant['idassistant']; ?> name="idassistant">
                    </form>
                </td>
                <td  align="center">
                    <a class="btn btn-sm btn-primary" href="deleteAssistant.php?idassistant=<?php echo $assistant['idassistant']; ?>">Delete</a>
                </td>
            </tr>
            </tbody>
