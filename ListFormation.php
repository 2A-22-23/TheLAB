...
<div class="container-fluid pt-4 px-4">
        ...
        ?>
          <tbody>
                ...
                <td><?= $formation['Article']; ?></td>
                <td><?= $formation['pd_img']; ?></td>
                <td align="center">
                ...
                <td  align="center">
                    <a class="btn btn-sm btn-primary" href="deleteformation.php?idformation=<?php echo $formation['idformation']; ?>">Delete</a>
                </td>
            </tr>
            </tbody>
